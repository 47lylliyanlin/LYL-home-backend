...
???????`docs/MEMORY_DIRECTION_V2.md`?

????????????Kiro ??? Gateway ?? Ombre-Brain???? Ombre-Brain-like memory core ??? Gateway ?????? Web / PWA / App ????????????????????? internal tool loop?????????? Relationship Weather / feel / I / Darkroom ????????
...
1. **A1 ?????????**
   - ?????????
   - ??????????????????
   - ?? Word Map Lite ? ChromaDB?
   - ?????? 46 ???? 46 ?????? 0?

2. **A2 ??????**
   - Gateway `last-context` ?? `scene_explanations`?
   - Dashboard ?? Scene Memory ? keyword / vector / base / final ??
   - ???????????????????????
...
1. ??????? 1-2 ???? Dashboard ?? `scene_explanations` ????????????
2. ?????????????? session assistant ??????????????????
3. ?? token ????????????????? assistant ?????
